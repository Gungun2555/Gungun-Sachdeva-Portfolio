...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-base-100 via-base-200 to-base-300 text-base-content py-10 mt-20">
      <motion.div
      ...
      >
        ...
        <div>
          ...
          <div className="flex gap-5">
            <a
              href="https://github.com/Gungun2555"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/gungun-sachdeva-here/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xl hover:text-primary transition-all"
            >
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&to=gungunsachdevahere@gmail.com"
              className="text-xl hover:text-primary transition-all"
            >
              <FaEnvelope />
            </a>
      ...
      >
        &copy; {new Date().getFullYear()} Gungun Sachdeva. All rights reserved.
      </motion.div>
    </footer>
  );
};
